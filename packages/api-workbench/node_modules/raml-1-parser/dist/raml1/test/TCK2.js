...
describe('Complete TCK Test Set', function () {
    ...
    describe('RAML08/Parameters', function () {
        it("test001/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML08/Parameters/test001/api.raml");
        });
    });
    ...
    describe('RAML10/Annotations', function () {
        ...
        it("test006/apiValid1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test006/apiValid1.raml");
        });
        ...
        it("test034/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test034/api.raml");
        });
        it("test035/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test035/api.raml");
        });
        it("test036/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test036/api.raml");
        });
        it("test037/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test037/api.raml");
        });
    });
    describe('RAML10/Api', function () {
        ...
        it("test030/emptyApi.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Api/test030/emptyApi.raml");
        });
        it("test031/emptyApiNewLine.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Api/test031/emptyApiNewLine.raml");
        });
        it("test032/emptyApi2NewLine.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Api/test032/emptyApi2NewLine.raml");
        });
        it("test033/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Api/test033/api.raml");
        });
        it("test034/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Api/test034/api.raml");
        });
        it("test035/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Api/test035/api.raml");
        });
    });
    describe('RAML10/Examples', function () {
        ...
        it("test053/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test053/lib.raml");
        });
        it("test054/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test054/lib.raml");
        });
        it("test055/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test055/lib.raml");
        });
        it("test056/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test056/lib.raml");
        });
        it("test057/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test057/lib.raml");
        });
        it("test058/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test058/api.raml");
        });
        it("test059/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test059/api.raml");
        });
        it("test060/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test060/api.raml");
        });
        it("test061/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test061/api.raml");
        });
        it("test062/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test062/lib.raml");
        });
        it("test063/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test063/lib.raml");
        });
    });
    ...
    describe('RAML10/Fragments', function () {
        ...
        it("test006/Example1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Fragments/test006/Example1.raml");
        });
        it("test006/Example2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Fragments/test006/Example2.raml");
        });
        it("test006/Example3.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Fragments/test006/Example3.raml");
        });
        it("test007/annotation1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Fragments/test007/annotation1.raml");
        });
        it("test007/annotation2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Fragments/test007/annotation2.raml");
        });
    });
    ...
    describe('RAML10/MethodResponses', function () {
        ...
        it("test006/methResp06.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/MethodResponses/test006/methResp06.raml");
        });
    });
    ...
    describe('RAML10/Overlays', function () {
        ...
        it("test029/overlay.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Overlays/test029/overlay.raml", null, "TCK/RAML10/Overlays/test029/api-tck.json");
        });
    });
    describe('RAML10/ReferencesPatching/Annotations', function () {
        it("test001/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Annotations/test001/api.raml");
        });
        it("test002/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Annotations/test002/api.raml");
        });
        it("test003/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Annotations/test003/api.raml");
        });
        it("test004/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Annotations/test004/api.raml");
        });
    });
    describe('RAML10/ReferencesPatching/Fragments', function () {
        it("test001/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test001/api.raml");
        });
        it("test002/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test002/api.raml");
        });
        it("test003/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test003/api.raml");
        });
        it("test004/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test004/api.raml");
        });
        it("test005/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test005/api.raml");
        });
        it("test006/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test006/api.raml");
        });
        it("test007/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test007/api.raml");
        });
        it("test008/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Fragments/test008/api.raml");
        });
    });
    describe('RAML10/ReferencesPatching/ResourceTypes', function () {
        it("test001/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/ResourceTypes/test001/api.raml");
        });
        it("test002/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/ResourceTypes/test002/api.raml");
        });
        it("test003/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/ResourceTypes/test003/api.raml");
        });
        it("test004/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/ResourceTypes/test004/api.raml");
        });
        it("test005/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/ResourceTypes/test005/api.raml");
        });
    });
    describe('RAML10/ReferencesPatching/Traits', function () {
        it("test001/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Traits/test001/api.raml");
        });
        it("test002/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Traits/test002/api.raml");
        });
        it("test003/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/ReferencesPatching/Traits/test003/api.raml");
        });
    });
    ...
    describe('RAML10/Types', function () {
        ...
        it("test027/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test027/lib.raml");
        });
        it("test028/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test028/lib.raml");
        });
        it("test029/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test029/lib.raml");
        });
        it("test030/lib.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test030/lib.raml");
        });
        it("test031/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test031/api.raml");
        });
        it("test032/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test032/api.raml");
        });
        it("test033/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test033/apiValid.raml");
        });
        it("test034/apiValid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/test034/apiValid.raml");
        });
    });
    ...
    describe('RAML10/Types/ObjectTypes', function () {
        ...
        it("test018/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test018/api.raml");
        });
        it("test019/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test019/api.raml");
        });
        it("test020/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test020/api.raml");
        });
        it("test021/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test021/api.raml");
        });
        it("test022/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test022/api.raml");
        });
        it("test023/api.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Types/ObjectTypes/test023/api.raml");
        });
    });
    ...
    describe('RAML10/spec-examples', function () {
        it("APIs/additional-facets-single-example.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/additional-facets-single-example.raml");
        });
        it("APIs/additional-properties.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/additional-properties.raml");
        });
        it("APIs/annotating-scalar-nodes.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/annotating-scalar-nodes.raml");
        });
        it("APIs/annotations-targets.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/annotations-targets.raml");
        });
        it("APIs/annotations.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/annotations.raml");
        });
        it("APIs/apply-annotations-1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/apply-annotations-1.raml");
        });
        it("APIs/apply-annotations-2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/apply-annotations-2.raml");
        });
        it("APIs/apply-default-media-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/apply-default-media-type.raml");
        });
        it("APIs/apply-resourcetypes-traits.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/apply-resourcetypes-traits.raml");
        });
        it("APIs/apply-security-scheme-null.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/apply-security-scheme-null.raml");
        });
        it("APIs/apply-security-schemes.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/apply-security-schemes.raml");
        });
        it("APIs/apply-securityscheme-parameter.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/apply-securityscheme-parameter.raml");
        });
        it("APIs/array-type-expanded.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/array-type-expanded.raml");
        });
        it("APIs/array-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/array-type.raml");
        });
        it("APIs/array-uri-parameter.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/array-uri-parameter.raml");
        });
        it("APIs/base-uri-parameter.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/base-uri-parameter.raml");
        });
        it("APIs/base-uri-template.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/base-uri-template.raml");
        });
        it("APIs/bodies.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/bodies.raml");
        });
        it("APIs/boolean-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/boolean-type.raml");
        });
        it("APIs/complex-examples.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/complex-examples.raml");
        });
        it("APIs/complex-headers.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/complex-headers.raml");
        });
        it("APIs/date-types.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/date-types.raml");
        });
        it("APIs/default-media-types-multiple.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-media-types-multiple.raml");
        });
        it("APIs/default-media-types-single.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-media-types-single.raml");
        });
        it("APIs/default-security.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-security.raml");
        });
        it("APIs/default-type-5.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-type-5.raml");
        });
        it("APIs/default-type-any-2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-type-any-2.raml");
        });
        it("APIs/default-type-any.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-type-any.raml");
        });
        it("APIs/default-type-object.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-type-object.raml");
        });
        it("APIs/default-type-string.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-type-string.raml");
        });
        it("APIs/default-types-1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-types-1.raml");
        });
        it("APIs/default-types-2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-types-2.raml");
        });
        it("APIs/default-types-3.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-types-3.raml");
        });
        it("APIs/default-types-4.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/default-types-4.raml");
        });
        it("APIs/define-uri-parameters.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/define-uri-parameters.raml");
        });
        it("APIs/documentation.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/documentation.raml");
        });
        it("APIs/duplicated-uris-invalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/duplicated-uris-invalid.raml");
        });
        it("APIs/external-type-extend-invalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/external-type-extend-invalid.raml");
        });
        it("APIs/external-types-invalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/external-types-invalid.raml");
        });
        it("APIs/external-types.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/external-types.raml");
        });
        it("APIs/file-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/file-type.raml");
        });
        it("APIs/fragments-simple.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/fragments-simple.raml");
        });
        it("APIs/includes.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/includes.raml");
        });
        it("APIs/inline-type-declaration.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/inline-type-declaration.raml");
        });
        it("APIs/integer-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/integer-type.raml");
        });
        it("APIs/introduction-types-complex.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/introduction-types-complex.raml");
        });
        it("APIs/introduction-types.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/introduction-types.raml");
        });
        it("APIs/invalid-discriminator-usage.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/invalid-discriminator-usage.raml");
        });
        it("APIs/librarybooks.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/librarybooks.raml");
        });
        it("APIs/markup-language.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/markup-language.raml");
        });
        it("APIs/multiple-examples.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/multiple-examples.raml");
        });
        it("APIs/multiple-inheritance-1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/multiple-inheritance-1.raml");
        });
        it("APIs/multiple-inheritance-2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/multiple-inheritance-2.raml");
        });
        it("APIs/multiple-inheritance-3-invalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/multiple-inheritance-3-invalid.raml");
        });
        it("APIs/nested-resources.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/nested-resources.raml");
        });
        it("APIs/null-type-invalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/null-type-invalid.raml");
        });
        it("APIs/null-type-union.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/null-type-union.raml");
        });
        it("APIs/null-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/null-type.raml");
        });
        it("APIs/number-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/number-type.raml");
        });
        it("APIs/object-type-long.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/object-type-long.raml");
        });
        it("APIs/object-type-short.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/object-type-short.raml");
        });
        it("APIs/protocols.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/protocols.raml");
        });
        it("APIs/query-parameter.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/query-parameter.raml");
        });
        it("APIs/query-string.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/query-string.raml");
        });
        it("APIs/resolve-includes.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/resolve-includes.raml");
        });
        it("APIs/resourcetypes-optionalmethods.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/resourcetypes-optionalmethods.raml");
        });
        it("APIs/resourcetypes-traits-no-subresources.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/resourcetypes-traits-no-subresources.raml");
        });
        it("APIs/resourcetypes-traits-parameter.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/resourcetypes-traits-parameter.raml");
        });
        it("APIs/resourcetypes-traits-parameterfunctions.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/resourcetypes-traits-parameterfunctions.raml");
        });
        it("APIs/resourcetypes-traits.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/resourcetypes-traits.raml");
        });
        it("APIs/responses.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/responses.raml");
        });
        it("APIs/resurcetypes-traits-external.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/resurcetypes-traits-external.raml");
        });
        it("APIs/root.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/root.raml");
        });
        it("APIs/security-schemes-basic.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/security-schemes-basic.raml");
        });
        it("APIs/security-schemes-digest.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/security-schemes-digest.raml");
        });
        it("APIs/security-schemes-oauth1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/security-schemes-oauth1.raml");
        });
        it("APIs/security-schemes-oauth2.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/security-schemes-oauth2.raml");
        });
        it("APIs/security-schemes-pass.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/security-schemes-pass.raml");
        });
        it("APIs/security-schemes-xother.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/security-schemes-xother.raml");
        });
        it("APIs/security-schemes.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/security-schemes.raml");
        });
        it("APIs/simple-header.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/simple-header.raml");
        });
        it("APIs/single-example.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/single-example.raml");
        });
        it("APIs/string-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/string-type.raml");
        });
        it("APIs/template-uri-1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/template-uri-1.raml");
        });
        it("APIs/trailing-slashes.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/trailing-slashes.raml");
        });
        it("APIs/traits-merge-enumlist.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/traits-merge-enumlist.raml");
        });
        it("APIs/type-expression-extends.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/type-expression-extends.raml");
        });
        it("APIs/type-expression.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/type-expression.raml");
        });
        it("APIs/type-names-question-mark.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/type-names-question-mark.raml");
        });
        it("APIs/type-schema-invalid.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/type-schema-invalid.raml");
        });
        it("APIs/types-pattern-properties.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/types-pattern-properties.raml");
        });
        it("APIs/union-type-multiple-inheritance.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/union-type-multiple-inheritance.raml");
        });
        it("APIs/union-type.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/union-type.raml");
        });
        it("APIs/uri-parameters-1.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/uri-parameters-1.raml");
        });
        it("APIs/uri-parameters-ext.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/uri-parameters-ext.raml");
        });
        it("APIs/uri-templates-allowed.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/uri-templates-allowed.raml");
        });
        it("APIs/user-defined-facets.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/user-defined-facets.raml");
        });
        it("APIs/using-discriminator.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/using-discriminator.raml");
        });
        it("APIs/using-discriminatorvalue.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/using-discriminatorvalue.raml");
        });
        it("APIs/xml-facet.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/APIs/xml-facet.raml");
        });
        it("Fragments/libraries-invalid-chaining.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/Fragments/libraries-invalid-chaining.raml");
        });
        it("Fragments/libraries-resourcetype.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/Fragments/libraries-resourcetype.raml");
        });
        it("Libraries/libraries.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/Libraries/libraries.raml");
        });
    });
    describe('RAML10/spec-examples/ExtensionsAndOverlays', function () {
        it("Extension 001/extension-post.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/ExtensionsAndOverlays/Extension 001/extension-post.raml", null, "TCK/RAML10/spec-examples/ExtensionsAndOverlays/Extension 001/librarybooks-tck.json");
        });
        it("Overlay 001/overlay-monitoring.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/ExtensionsAndOverlays/Overlay 001/overlay-monitoring.raml", null, "TCK/RAML10/spec-examples/ExtensionsAndOverlays/Overlay 001/librarybooks-tck.json");
        });
        it("Overlay 002/overlay-spanish.raml", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/spec-examples/ExtensionsAndOverlays/Overlay 002/overlay-spanish.raml", null, "TCK/RAML10/spec-examples/ExtensionsAndOverlays/Overlay 002/librarybooks-tck.json");
        });
    });
});
